...
Qwen 3.7 Flash é usado pelo claude-mem. O setup remove overrides antigos de
...
Os provedores principais usam `http://127.0.0.1:20128/v1`. Plan e claude-mem
chamam OpenRouter diretamente. Cada família local usa seu
